...
public class RSAEncryptionExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(
                "加密后(base64编码): " + java.util.Base64.getEncoder().encodeToString(encryptedText));
