...
public class UidProperties {
    ...
    /**
     * 时间位 ----------------------------------------------------------------------------------
     * ----------sign:1bit | deltaSecoonds:32bit | workerNode:22bit | sequence:9bit------
     * 关于UID比特分配的建议： 对于并发数要求不高、期望长期使用的应用, 可增加timeBits位数, 减少seqBits位数. 例如节点采取用完即弃的WorkerIdAssigner策略,
     * 重启频率为12次/天, 那么配置成： {"timeBits":31,"workerBits":23,"seqBits":9}时, 可支持28个节点以整体并发量14400
     ...
     * {"timeBits":30,"workerBits":27,"seqBits":6}时, 可支持37个节点以整体并发量2400 UID/s的速度持续运行34年.
     * ----------------------------------------------------------------------------------
     */
