...
package org.gnrd.uid.impl;

import org.gnrd.uid.BitsAllocator;
import org.gnrd.uid.UidGenerator;
import org.gnrd.uid.buffer.BufferPaddingExecutor;
import org.gnrd.uid.buffer.RejectedPutBufferHandler;
import org.gnrd.uid.buffer.RejectedTakeBufferHandler;
import org.gnrd.uid.buffer.RingBuffer;
...
public class CachedUidGenerator extends DefaultUidGenerator implements DisposableBean {
    ...
    private void initRingBuffer() {
        ...
        LOGGER.info("Initialized BufferPaddingExecutor. Using schdule:{}, interval:{}",
                usingSchedule, scheduleInterval);
