 ...
 * Using array could improve read element performance due to the CUP cache line. To prevent the side
 * effect of False Sharing, {@link PaddedAtomicLong} is using on 'tail' and 'cursor'
 * <p>
 * 
...
public class RingBuffer {
     ...
     * We use 'synchronized' to guarantee the UID fill in slot & publish new tail sequence as atomic
     * operations<br>
     * 
     ...
     * operation will be triggered in another thread<br>
    ...
    public long take() {
        ...
        if (currentTail - nextCursor < paddingThreshold) {
            LOGGER.debug("Reach the padding threshold:{}. tail:{}, cursor:{}, rest:{}",
        ...
        Assert.isTrue(flags[nextCursorIndex].get() == CAN_TAKE_FLAG,
                "Curosr not in can take status");
    ...
    public String toString() {
        ...
        builder.append("RingBuffer [bufferSize=").append(bufferSize).append(", tail=").append(tail)
                .append(", cursor=").append(cursor).append(", paddingThreshold=")
                .append(paddingThreshold).append("]");
