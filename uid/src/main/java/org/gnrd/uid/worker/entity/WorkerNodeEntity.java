...
public class WorkerNodeEntity implements Serializable {
    ...
    @TableGenerator(name = "WorkNodeId", table = "tb_generator", pkColumnName = "gen_name", schema = "public",
            valueColumnName = "gen_value", pkColumnValue = "WorkNodeId", allocationSize = 1)
    private Long id;
