...
import org.gnrd.uid.utils.DockerUtils;
import org.gnrd.uid.utils.NetUtils;
import org.gnrd.uid.worker.dao.WorkerNodeDAO;
...
public class DisposableWorkerIdAssigner implements WorkerIdAssigner {
     ...
     * <p>
     * If there is host name & port in the environment, we considered that the node runs in Docker
     * container<br>
    ...
    private WorkerNodeEntity buildWorkerNode() {
        ...
        if (DockerUtils.isDocker()) {
            ...
            workerNodeEntity
                    .setPort(System.currentTimeMillis() + "-" + RandomUtils.nextInt(100000));
        }
